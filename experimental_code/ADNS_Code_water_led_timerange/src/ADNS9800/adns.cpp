...
void ADNS::triggerSampleCapture() {
  ...
  _sample.displacement.shutterL = _readout.shutterPeriodL;
  _sample.displacement.shutterH = _readout.shutterPeriodH;
...
displacement_t ADNS::readDisplacement(const unit_specification_t unit) const {
  ...
  u.shutterL = _sample.displacement.shutterL;
  u.shutterH = _sample.displacement.shutterH;
  return u;
}

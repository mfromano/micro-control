...
[b,a] = butter(8,[1000/(data.streams.Soun.fs/2) 3000/(data.streams.Soun.fs/2)],'bandpass');
...
st.sound_start = taxis_sound_tdt(sound_on)' - (tdt_camera_times(tone_starts1)-tdt_camera_times(1));
st.sound_length = taxis_sound_tdt(sound_off+1)-taxis_sound_tdt(sound_on);
    

%% now get timing of sound and associated statistics
% times recorded on external device
[b,a] = butter(8,[7000/(data.streams.Soun.fs/2) 9000/(data.streams.Soun.fs/2)],'bandpass');
...
st.sound_start = taxis_sound_tdt(sound_on)' - (tdt_camera_times(tone_starts2)-tdt_camera_times(1));
st.sound_length = taxis_sound_tdt(sound_off+1)-taxis_sound_tdt(sound_on);

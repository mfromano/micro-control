fi = fopen('micro-control-data/mike_2tonetonepuff_442pm_022619/mike_445_finaltickbugfix_2000Hz1_0.05amp1_8000Hz2_0.2amp2.txt')
...
save('micro-control-data/mike_445_finaltickbugfix_2000Hz1_0.05amp1_8000Hz2_0.2amp2.mat','tbl');

%% now extract data from tdt files
load('micro-control-data/mike_445_finaltickbugfix_2000Hz1_0.05amp1_8000Hz2_0.2amp2.mat','tbl');

d = 'micro-control-data/mike_2tonetonepuff_442pm_022619/Block-1';
data = TDTbin2mat(d);
